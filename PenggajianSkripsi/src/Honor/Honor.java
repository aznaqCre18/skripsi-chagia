 ...
 */
public class Honor extends javax.swing.JFrame {
    ...
    protected void dataTable() {
        ...
        tableHonor.setModel(tabMode);
        String query = "SELECT * FROM honor WHERE bidang_studi LIKE'%"+ searchTxt.getText() +"%' ORDER BY bidang_studi ASC";
        ...
        try {
            ...
            int no = 1;
            while(rs.next()) {
                String idHonor = rs.getString("id");
                String namaMapel = rs.getString("bidang_studi");
                String honor = rs.getString("honor");
                
                String[] data = { Integer.toString(no), idHonor, namaMapel, honor };
                tabMode.addRow(data);
                no++;
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        mapelTxt = new javax.swing.JPanel();
        ...
        tableHonor = new javax.swing.JTable();
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/btnHonorAct.png"))); // NOI18N
        ...
        mapelTxt.setBackground(new java.awt.Color(255, 255, 255));
        ...
        javax.swing.GroupLayout mapelTxtLayout = new javax.swing.GroupLayout(mapelTxt);
        mapelTxt.setLayout(mapelTxtLayout);
        mapelTxtLayout.setHorizontalGroup(
            mapelTxtLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(mapelTxtLayout.createSequentialGroup()
                .addGap(32, 32, 32)
                .addGroup(mapelTxtLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                ...
                .addGroup(mapelTxtLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel14)
                    .addComponent(honorTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 325, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(32, 32, 32))
        );
        mapelTxtLayout.setVerticalGroup(
            mapelTxtLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(mapelTxtLayout.createSequentialGroup()
                .addGap(24, 24, 24)
                .addGroup(mapelTxtLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(mapelTxtLayout.createSequentialGroup()
                        .addComponent(jLabel9)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, mapelTxtLayout.createSequentialGroup()
                        .addComponent(jLabel14)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(honorTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        tableHonor.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "No", "ID", "Nama Mata Pelajaran", "Honor"
            }
        ));
        tableHonor.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableHonorMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tableHonor);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(mapelTxt, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(fullname)))
                .addGap(32, 32, 32)
                .addComponent(mapelTxt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        // TODO add your handling code here:
        String query = "INSERT INTO honor VALUES (?, ?, ?)";
        try {
            PreparedStatement stat = conn.prepareStatement(query);
            
            stat.setString(1, null);
            stat.setString(2, namaTxt.getText());
            stat.setString(3, honorTxt.getText());
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        // TODO add your handling code here:
        String query = "UPDATE honor SET bidang_studi=?, honor=? where id=?";
        PreparedStatement stat;
        
        try {
            stat = conn.prepareStatement(query);
            stat.setString(1, namaTxt.getText());
            stat.setString(2, honorTxt.getText());
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        String query = "DELETE FROM honor WHERE id='" + idTxt.getText() + "'";
    ...
    private void cetakBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakBtnActionPerformed
        ...
        String path = ".\\src\\Reports\\reportHonor.jasper";
        try {
    ...
    private void tableHonorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableHonorMouseClicked
        // TODO add your handling code here:
        saveBtn.setEnabled(false);
        editBtn.setEnabled(true);
        deleteBtn.setEnabled(true);
        clearBtn.setEnabled(true);
        int bar = tableHonor.getSelectedRow();
        
        String id = tabMode.getValueAt(bar, 1).toString();
        String namaMapel = tabMode.getValueAt(bar, 2).toString();
        String honor = tabMode.getValueAt(bar, 3).toString();
        
        idTxt.setText(id);
        namaTxt.setText(namaMapel);
        honorTxt.setText(honor);
    }//GEN-LAST:event_tableHonorMouseClicked
    ...
    private javax.swing.JPanel mapelTxt;
    private javax.swing.JTextField namaTxt;
    private javax.swing.JButton saveBtn;
    private javax.swing.JTextField searchTxt;
    private javax.swing.JTable tableHonor;
